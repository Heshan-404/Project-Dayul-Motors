...
const originalRows = [
  createData(1, "10010", "2024-05-14", "10:30 AM", 100.0, "Canceled"),
  createData(2, "10004", "2024-05-15", "12:45 PM", 150.0, "Canceled"),
  createData(3, "10003", "2024-05-16", "09:15 AM", 120.0, "Canceled"),
  createData(4, "10002", "2024-05-17", "03:20 PM", 200.0, "Canceled"),
...
export default function CanceledOrders({ searchValue }) {
