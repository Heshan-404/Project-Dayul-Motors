...
const OrderSuccessPage = () => {
  ...
  return (
    <div style={styles.container}>
      <img src={successIcon} alt="successIcon" style={styles.icon} /> {/* Add the icon */}
      <h1 style={styles.heading}>Order Successful!</h1>
      <h2 style={styles.paragraph}>Thank you for your order. Your order has been successfully placed.</h2>
      <Link to="/shop" style={styles.button}>Back to Shop</Link> {/* Add the back to shop button */}
